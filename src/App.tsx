...
function App() {
  return (
    <VantaBackground>
      <div className="min-h-screen text-slate-200 selection:bg-emerald-500/30 selection:text-emerald-400">
        <Navbar />
        <main>
          <Hero />
          <NetworkStats />
          ...
          <section className="py-32 relative">
            <div className="max-w-5xl mx-auto px-6 text-center">
              <div className="p-16 rounded-[3rem] bg-slate-900/40 backdrop-blur-md border border-slate-800 relative overflow-hidden group">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-500 to-transparent"></div>
                <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter">
                  READY TO SCALE <br /> <span className="text-gradient">INFINITELY?</span>
                </h2>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  <button className="bg-emerald-500 text-slate-950 px-12 py-5 rounded-2xl font-black text-lg hover:scale-105 hover:bg-emerald-400 transition-all shadow-[0_0_40px_rgba(16,185,129,0.2)]">
                    GET STARTED NOW
                  </button>
          ...
          {/* Dark Minimal Footer */}
          <footer className="bg-slate-950/40 backdrop-blur-md py-20 border-t border-slate-900">
